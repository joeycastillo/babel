...
BABEL_CODEPOINT string[] = {0x0048, 0x0065, 0x006C, 0x006C, 0x006F, 0x0020, 0x0057, 0x006F, 0x0072, 0x006C, 0x0064, 0x0021, 0x000A, 0x05E9, 0x05DC, 0x05D5, 0x05DD, 0x0020, 0x05E2, 0x05D5, 0x05DC, 0x05DD, 0x000A, 0x0CB9, 0x0CB2, 0x0CCB, 0x0020, 0x0CB5, 0x0CB0, 0x0CCD, 0x0CB2, 0x0CCD, 0x0CA1, 0x0CCD, 0x000A, 0x0645, 0x0631, 0x062D, 0x0628, 0x0627, 0x0020, 0x0628, 0x0627, 0x0644, 0x0639, 0x0627, 0x0644, 0x0645, 0x000A, 0x041F, 0x0440, 0x0438, 0x0432, 0x0435, 0x0442, 0x002C, 0x0020, 0x043C, 0x0438, 0x0440, 0x0021, 0x000A, 0xFEE3, 0xFEAE, 0xFEA3, 0xFE92, 0xFE8E, 0x0020, 0xFE91, 0xFE8E, 0xFEDF, 0xFECC, 0xFE8E, 0xFEDF, 0xFEE2, 0x000A, 0x0020, 0x0048, 0x006F, 0x006C, 0x0061, 0x0020, 0x004D, 0x0075, 0x006E, 0x0064, 0x006F, 0x0021, 0x000A, 0x0020};

void loop() {
  Serial.println("clearing");
  display.fillScreen(GxEPD_WHITE);
  typesetter.setCursor(16, 16);
  typesetter.writeCodepoints(string, 90);
